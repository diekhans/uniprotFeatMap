...
* uniprotMapAnnots use something like uniprotProteinTranscriptMap  mkPslMapCmd and add check option

* should NMD being include?

* look at cases in/testUniprotProteinTranscriptMapBasic.problems.tsv
